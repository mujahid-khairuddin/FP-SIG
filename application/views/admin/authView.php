              ...
              <div class="animate form-login">
                <section class="">
                  <form action="<?=site_url('admin/auth/check')?>" method="POST">
                    <h2 class="text-danger"><i class="fa fa-map-marker"></i> WebGIS-Covid19 Kabupaten Kuningan</h2>
                    <h1>Masuk untuk memulai sesi</h1>
                    <?=$this->session->flashdata('info')?>
                    <div class="form-group">
                      <label>Nama Pengguna</label>
                      <input type="text" class="form-control" placeholder="Nama Pengguna" name="nm_pengguna" required="" />
                    </div>
                    <div class="form-group">
