 <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-map"></i> <span>WEBGIS</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-folder"></i>Data <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="<?=site_url('admin/kategorihotspot')?>">Kategori Kasus</a></li>
                    </ul>
                  </li>
                  <?php } ?>
                   <li><a><i class="fa fa-tags"></i> Pencatatan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=site_url('admin/hotspot')?>">Kasus</a></li>
                    </ul>
                  </li>
